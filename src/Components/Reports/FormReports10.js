...
if(prevState.id){
  ...
  render() {
    ...
    if (
      ...
      options1 = this.state.AllReportTypes.services.map((obj, idx) => {
    ...
    return (
      ...
      >
        <div className="report-question">
          ...
          service in the last <span className="empty-place fill2" >{this.state.days}</span>
        </div>
        ...
        <div className="row">
          <div className="custom-select col-sm-12 select1">
            <input
              type="text"
              className="search-selectbox firstText" autoComplete="off"
            />
            {options1 && (
              <Select
          ...
          <div className="custom-select col-sm-3 select2">
            <input
              type="text"
              className="search-selectbox secondText" autoComplete="off"
        ...
        <input
          ...
          defaultValue="appointment" autoComplete="off"
        />
        <input
          type="hidden"
          name="service_id"
          defaultValue=""
          className="sel_in" autoComplete="off"
        />
        <input
          type="hidden"
          name="days"
