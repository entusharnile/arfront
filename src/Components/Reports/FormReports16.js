...
class FormReports16 extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    if (this.props.AllReportTypes != undefined && this.props.AllReportTypes.services.length > 0) {
      ...
      return (
                    <div style={{ opacity: "1" }} className="report-question-outer report-filling  fill-report no-padding" data-id={16}>
                      <input type="hidden" name="report_category" defaultValue="client" />
                      <div className="report-question">All women over  <span className="empty-place number_class" >{this.state.age}</span> years of age</div>
