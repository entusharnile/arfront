...
class FormReports12 extends Component {
  constructor(props) {
    super(props);
...
serviceOptions.push(obj.name);
    ...
    if (this.state.AllReportTypes != undefined && this.state.AllReportTypes.services.length > 0) {
      ...
      return (
                    ...
                    <div style={{ opacity: "1" }} className="report-question-outer report-filling  fill-report no-padding" data-id={12}>
                      <div className="report-question">What days of the week is the following  <span className="empty-place fill1" > {serviceOptions.join(',')}</span>service booked more times (Mon - Sunday scale) </div>
