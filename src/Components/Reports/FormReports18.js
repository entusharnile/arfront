...
class FormReports18 extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    if (this.state.AllReportTypes != undefined && this.state.AllReportTypes.providers.length > 0) {
      ...
      return (
                    ...
                    <div style={{ opacity: "1" }} className="report-question-outer report-filling  fill-report no-padding" data-id={18}>
                      <div className="report-question">Average sale per <span className="empty-place fill1" >{providerOptions.join(',')} </span>provider</div>
                      <div className="report-instruction">
                      {this.state.reportsLang.report_type_select}
                      </div>
                      <div className="row">
                        <div className="custom-select col-sm-12 select1">
                          <input type="text" className="search-selectbox firstText" style={{display:'block'}} autoComplete="off" />
                          {
                               options && <Select
