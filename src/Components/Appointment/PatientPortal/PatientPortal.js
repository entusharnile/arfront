...
class PatientPortal extends Component {
  ...
  render() {
    ...
    return (
              ...
              <div >
                <div className="row portal-stats-outer">
                  <div className="col-sm-4 col-xs-12">
                    ...
                    <div className="patient-portal-label">{this.state.appointmentLang.appointment_Total_no_clients_val}</div>
                  </div>
                  <div className="col-sm-4 col-xs-12">
                    <div name="portal_active_patients"  className="portal-numbers">{this.state.portal_active_patients}</div>
                    <div  className="patient-portal-label">{this.state.appointmentLang.appointment_client_portal_active}</div>
                  </div>
                  <div className="col-sm-4 col-xs-12">
                    <div name="portal_inactive_patients" className="portal-numbers">{this.state.portal_inactive_patients}</div>
                    <div className="patient-portal-label">{this.state.appointmentLang.appointment_client_portal_inactive}</div>
                    <a className="new-white-btn confirm-model" data-message="Are you sure you want to activate patient portal for all clients? <br>(It may take few hours to activate)" data-dismiss="modal" onClick={this.showDeleteModal} data-confirm-url="/settings/toggle_portal_access">{this.state.appointmentLang.appointment_activate_now}</a>
                      ...
                      <div className="modal-dialog">
                        <div className="modal-content">
                          <div className="modal-header">
                            ...
                            <h4 className="modal-title" id="model_title">{this.state.appointmentLang.appointment_confirmation_require}{this.state.showModal}</h4>
                          </div>
                          <div id="errorwindow" className="modal-body add-patient-form filter-patient">
                          {this.state.appointmentLang.appointment_activate_portal_msg}
                          </div>
                          <div className="modal-footer" >
                            ...
                            <button type="button" className="btn btn-success pull-right m-r-10" data-dismiss="modal" onClick={this.handleClick}>{this.state.appointmentLang.yes_option}</button>
                          </div>
                            </div>
                            </div>
                            </div>
          ...
          <div className="setting-title m-b-60">{this.state.appointmentLang.appointment_client_portal_email_conetent}<a title="Your very own patient portal" className="help-icon">?</a>
            ...
            <div className="row">
              <div className="col-lg-6 col-xs-12">
                <div className="newInputFileldOuter">
                  <div className="newInputLabel">{this.state.appointmentLang.appointment_email_subject}<span className="setting-require">*</span></div>
              ...
              <div className="col-xs-12">
                <div className="newInputFileldOuter">
                  <div className="newInputLabel">{this.state.appointmentLang.appointment_email_body} <span className="setting-require">*</span></div>
     ...
     {this.state.userData.account.account_preference.allow_patients_to_manage_appt == 0 &&
        <div className="row"><span className="m-l-10">{this.state.appointmentLang.appointment_customer_portal_disabled}</span> <span><Link  className="easy-link p-t-0 p-l-10" to="/appointment/booking-portal">{this.state.appointmentLang.appointment_change_settings}</Link></span></div>
     }
     </div>
    );
  }
